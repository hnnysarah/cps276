...
$elementsArr = [
  ...
  "email"=>[
		"errorMessage"=>"<span style='color: red; margin-left: 15px;'>Email must be a valid email address</span>",
    "errorOutput"=>"",
    "type"=>"text",
  ...
  "dob"=>[
		"errorMessage"=>"<span style='color: red; margin-left: 15px;'>Date of Birth must have this format mm/dd/yyy</span>",
    "errorOutput"=>"",
    "type"=>"text",
      "value"=>"12/25/1999",
      "regex"=>"dob"
...
$form = <<<HTML
    ...
    <div class="form-check form-check-inline mb-2">
      <input class="form-check-input" type="radio" name="age" id="age" value="30-50"  {$elementsArr['age']['value']['30-50']}>
