...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'sjiamjan';//this will be your WCC username
      $dbUsr = 'sjiamjan';//this will be your WCC username
      $dbPass = 'S7HA8eX7hduG';//this will be the password found in the video.
